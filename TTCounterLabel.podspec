Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://github.com/TriggerTrap/TTCounterLabel/blob/master/screenshot.PNG"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = { "Triggertrap Ltd" => "support@triggertrap.com", "Ross Gibson" => "ross@triggertrap.com" }
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/TriggerTrap/TTCounterLabel.git", :tag => "1.1.1" }
